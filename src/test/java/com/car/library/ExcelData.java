...
/**
 * Created by zenghuan on 2016/9/1.
 */
public class ExcelData {
    ...
    public String getPath() throws IOException {
       ...
       // sourceFile = directory.getCanonicalPath() + "\\src\\"+ fileName + ".xls";
        sourceFile = "E:\\zc_testplarm_server\\amsautotest\\testdata\\" + fileName + ".xls";
