...
//返回一个对象数组
    @DataProvider(name="vehicle-testnewcarSearch")
    public Object[][] Numbers() throws BiffException, IOException {
        //获取Excel数据，得到一个map，依次传给test
        ExcelData e=new ExcelData("vehicle_ios", "testnewcarSearch");
        return e.getExcelData();
    }


    @Test(dataProvider="vehicle-testnewcarSearch")
